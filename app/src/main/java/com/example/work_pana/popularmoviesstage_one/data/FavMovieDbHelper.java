...
public FavMovieDbHelper(Context context){
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        final String SQL_CREATE_MOVIE_TABLE = "CREATE TABLE IF NOT EXISTS " + FavMovieDbContract.MovieEntry.TABLE_NAME + "(" +
                FavMovieDbContract.MovieEntry._ID + " INTEGER PRIMARY KEY UNIQUE, " +
                ...
                // FavMovieDbContract.MovieEntry.COLUMN_TRAILERS + " TEXT NOT NULL," +
                //FavMovieDbContract.MovieEntry.COLUMN_REVIEWS + " TEXT NOT NULL" +
                ");";
